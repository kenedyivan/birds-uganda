...
public class ItemDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqlDatabaseHelper = new SQLDatabaseHelper(ItemDetailActivity.this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(sqlDatabaseHelper.getProfile().size()<1) {
                    ...
                    startActivity(new Intent(ItemDetailActivity.this,Chat.class));
        ...
        if (savedInstanceState == null) {
            ...
            tourPackage = DummyPackages.ITEMS.get(Integer.parseInt(getIntent()
                    .getStringExtra(ItemDetailFragment.ARG_ITEM_ID)) - 1);
            hero.setImageResource(tourPackage.hero);
