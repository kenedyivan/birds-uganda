...
public class FavoriteDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqlDatabaseHelper = new SQLDatabaseHelper(FavoriteDetailActivity.this);
                ...
                if(sqlDatabaseHelper.getProfile().size()<1) {
                    Snackbar.make(view, "User profile needed to chat, ", Snackbar.LENGTH_INDEFINITE)
                            .setAction("Login or Register ?", new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    startActivity(new Intent(FavoriteDetailActivity.this,LoginActivity.class));
                                }
                            }).show();
                } else {

                    startActivity(new Intent(FavoriteDetailActivity.this,Chat.class));
